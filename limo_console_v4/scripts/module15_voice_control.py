...
def start_voice_control():
    """
    启动语音控制功能
    1. 启动limo_base.launch
    2. 等待3秒
    3. 启动voice_ctr_node.py
    """
    processes = []
    ...
    try:
        ...
        # 启动limo_base.launch
        cmd1 = "roslaunch limo_base limo_base.launch"
        ...
        # 启动语音控制节点
        cmd2 = "rosrun voice voice_ctr_node.py"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("用法: python3 module15_voice_control.py [start|stop]")
        sys.exit(1)
